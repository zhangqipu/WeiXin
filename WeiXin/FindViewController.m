...
- (void)initDataSource
{
    ...
    self.dataSource
    = @[@[@{@"iconKey":@"friend", @"titleKey":@"朋友圈"}]
        , @[@{@"iconKey":@"scan", @"titleKey":@"扫一扫"}, @{@"iconKey":@"shake", @"titleKey":@"摇一摇"}]
        , @[@{@"iconKey":@"near_by", @"titleKey":@"附近的人"}, @{@"iconKey":@"bottle", @"titleKey":@"漂流瓶"}]
        , @[@{@"iconKey":@"shop", @"titleKey":@"购物"}, @{@"iconKey":@"game", @"titleKey":@"游戏"}]
        ];
}
